...
DESC="${DESC:-SchemeAFNoBoT_supervised_quad_fromW5_pa${PROJECTION_ALPHA}_fa${FUSION_ALPHA}_ca${CALIBRATION_ALPHA}_fw${FUSION_ID_WEIGHT}_${FUSION_TRIPLET_WEIGHT}_t10_buptcampus_v100_bs$((P_NUM * K_NUM))}"
