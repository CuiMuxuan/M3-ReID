...
EVAL_SAMPLE_MODE="${EVAL_SAMPLE_MODE:-evenly}"
EVAL_FP16="${EVAL_FP16:-1}"
PERSISTENT_WORKERS="${PERSISTENT_WORKERS:-0}"
PREFETCH_FACTOR="${PREFETCH_FACTOR:-2}"
DESC="${DESC:-NoRerank_${M3PLUS_MODE}_alpha${FUSION_ALPHA}_t10_hitszvcm_v100}"
...
python test_m3reid.py \
  ...
  --part_match_weight 0.0 \
  --part_rerank_topk 0 \
  --part_rerank_weight 0.0 \
  --reciprocal_topk 0 \
